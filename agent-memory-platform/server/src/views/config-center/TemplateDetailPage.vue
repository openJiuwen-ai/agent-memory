...
const defaultScopeConfigItems = (): ConfigItem[] => [
  ...
  { key: 'model_client_cfg.client_provider', value: 'SiliconFlow' },
  { key: 'model_client_cfg.api_base', value: 'https://api.siliconflow.cn/v1' },
  ...
  { key: 'embedding_cfg.base_url', value: 'https://api.siliconflow.cn/v1/embeddings' },
...
const defaultInstanceConfigItems = (): ConfigItem[] => [
  { key: 'MODEL_PROVIDER', value: 'SiliconFlow' },
  { key: 'API_BASE', value: 'https://api.siliconflow.cn/v1' },
  { key: 'API_KEY', value: '' },
  { key: 'MODEL_NAME', value: 'qwen-plus' },
  { key: 'EMBED_MODEL_NAME', value: 'BAAI/bge-m3' },
  { key: 'EMBED_API_BASE', value: 'https://api.siliconflow.cn/v1/embeddings' },
