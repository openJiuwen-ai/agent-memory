...
| [特性设计 docs/features/](docs/features/) | 各模块设计取舍（storage / construction / retrieval / control / common） |
| [技术规约](docs/specs/) | 各模块设计规约文档 |
| 开发者指导文档 [English](docs/en/)/[中文](docs/zh/) | 主要包含Agent接入指导， API 文档，FAQ, 安装指导等|
