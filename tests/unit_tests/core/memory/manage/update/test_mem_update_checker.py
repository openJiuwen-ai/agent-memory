...
from jiuwen_memory.memory_core.manage.update.mem_update_checker import (
    MemUpdateChecker,
    CheckResult,
    MemoryStatus,
    MemoryActionItem,
...
class TestMemUpdateChecker:
    ...
    def mock_prompt_applier(self):
        ...
        with patch('jiuwen_memory.memory_core.manage.update.mem_update_checker.PromptApplier') as mock:
            mock_instance = Mock()
    ...
    async def test_check_with_duplicate_ids(self, checker, mock_model_client, mock_prompt_applier):
        ...
        with patch('jiuwen_memory.memory_core.manage.update.mem_update_checker.JsonOutputParser') as mock_parser_class:
            mock_parser = Mock()
