...
from foundation.tool.mcp.base import NO_TIMEOUT
from foundation.tool import McpClient, McpServerConfig
from foundation.tool import McpToolCard
...
class OpenApiClient(McpClient):
    ...
    async def call_tool(self, tool_name, arguments: dict, *, timeout: float = NO_TIMEOUT) -> Any:
        from common.exception.errors import ExecutionError
        try:
