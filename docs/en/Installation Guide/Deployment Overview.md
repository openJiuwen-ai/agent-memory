...
runs MemoryAPI authorization. Until PR2 consumes the ROOT role, the local DEV composition root
temporarily selects the allow-all PermissionManager to preserve existing local workflows.
