...
from jiuwen_memory.memory_core.migration.operation.operation_registry import OperationRegistry
...
# Vector Example
from jiuwen_memory.memory_core.migration.operation.operations import RenameScalarFieldOperation
...
# Message Example
from jiuwen_memory.memory_core.migration.operation.operations import UpdateMessageOperation
...
from jiuwen_memory.memory_core.migration.operation.operations import RenameMemoryDocFieldOperation
...
from jiuwen_memory.memory_core.migration.operation.operations import AddMemoryDocFieldOperation
index_registry.register(
    "index_fragment",
...
from jiuwen_memory.memory_core.migration.operation.operations import RemoveMemoryDocFieldOperation
index_registry.register(
    "index_fragment",
...
from jiuwen_memory.memory_core.migration.operation.operations import TransformMemoryDocFieldOperation
index_registry.register(
    "index_fragment",
