...
def _get_loguru():
    ...
    from jiuwen_memory.common.logging.loguru import logger as _logger
    return _logger


from jiuwen_memory.common.logging.base_impl import (
    resolve_log_type_label,
    StructuredLoggerMixin,
)
from jiuwen_memory.common.logging.events import (
    BaseLogEvent,
    EventStatus,
    LogLevel,
    ModuleType,
...
from jiuwen_memory.common.logging.utils import get_session_id
...
class LoguruLogger(StructuredLoggerMixin, LoggerProtocol):
    ...
    def _patch_record(self, record: Dict[str, Any]) -> None:
        ...
        from jiuwen_memory.common.logging.utils import get_member_id
