...
from foundation.store.graph.graph_object import Entity, Relation
from memory_core.config.graph import EpisodeType
from memory_core.graph.extraction.base import MULTILINGUAL_DESCRIPTION
from memory_core.graph.extraction.prompts import TemplateManager
from memory_core.graph.extraction.prompts.entity_extraction.base import (
