...
class AuditEvent:
    ...
    # 常见约定：permission_check、permission_reason、permission_rule、job_id、
    # before_unit_id / after_unit_id、before_unit_ids / after_unit_ids
    # 安全层（src/common/security）另加：role、key_fp、auth_mode。
    # security.md §7.2 要求审计记录这些，但它们是**认证元数据**，与本结构
