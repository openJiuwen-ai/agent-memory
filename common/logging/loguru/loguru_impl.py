...
from common.logging.base_impl import (
    resolve_log_type_label,
    StructuredLoggerMixin,
)
from common.logging.events import (
    BaseLogEvent,
    EventStatus,
    LogLevel,
    ModuleType,
...
from common.logging.utils import get_session_id
...
class LoguruLogger(StructuredLoggerMixin, LoggerProtocol):
    ...
    def _patch_record(self, record: Dict[str, Any]) -> None:
        ...
        from common.logging.utils import get_member_id
